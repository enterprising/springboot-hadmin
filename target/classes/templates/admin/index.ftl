        ...
        <div class="sidebar-collapse">
            ...
            <#--</li>-->
                ...
                <li>
                    <a href="#">
                        <i class="fa fa fa-cog"></i>
                        <span class="nav-label">贫困助学管理</span>
                        <span class="fa arrow"></span>
                    </a>
                    <ul class="nav nav-second-level">
                    <@shiro.hasPermission name="system:role:index">
                        <li>
                            <a class="J_menuItem" href="${ctx!}/admin/role/index">助学管理</a>
                        </li>
                    </@shiro.hasPermission>
                    </ul>
                </li>
                <li>
                    <a href="#">
                        <i class="fa fa fa-cog"></i>
                        <span class="nav-label">公告通知管理</span>
                        <span class="fa arrow"></span>
                    </a>
                    <ul class="nav nav-second-level">
                    <@shiro.hasPermission name="system:user:index">
                        <li>
                            <a class="J_menuItem" href="${ctx!}/admin/article/sort/index">通知管理</a>
                        </li>
                    </@shiro.hasPermission>
                    </ul>
                </li>
                <li>
                    ...
                    <@shiro.hasPermission name="system:user:index">
                        <li>
                            <a class="J_menuItem" href="${ctx!}/admin/vacation/add">请假</a>
                        </li>
                    </@shiro.hasPermission>
                    <@shiro.hasPermission name="system:role:index">
                        <li>
                            <a class="J_menuItem" href="${ctx!}/admin/role/index">销假</a>
                        </li>
                    </@shiro.hasPermission>
                    </ul>
                </li>
